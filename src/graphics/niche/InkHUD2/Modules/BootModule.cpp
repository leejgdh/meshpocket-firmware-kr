...
void BootModule::renderPairing(RenderContext& ctx) {
    ...
    ctx.text(centerX, headerY, "Bluetooth", Align::CENTER, Color::BLACK, Layout::bodyScale);
    ...
    if (isFixedPin && hidePin) {
        ...
        ctx.text(centerX, midY - lineH / 2, "Pairing with", Align::CENTER, Color::BLACK, Layout::bodyScale);
        ctx.text(centerX, midY + lineH / 2, "predefined PIN", Align::CENTER, Color::BLACK, Layout::bodyScale);
    } else {
        ...
        ctx.text(centerX, enterCodeY, "Enter this code", Align::CENTER, Color::BLACK, Layout::bodyScale);
        ...
        ctx.text(centerX, pinY, pinStr, Align::CENTER, Color::BLACK, Layout::bodyScale);
    }
    ...
    meshtastic_NodeInfoLite *ourNode = nodeDB->getMeshNode(nodeDB->getNodeNum());
    if (ourNode && ourNode->has_user) {
        ctx.text(centerX, nameY, ourNode->user.short_name, Align::CENTER, Color::BLACK, Layout::bodyScale);
    }
}
